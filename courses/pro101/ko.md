...
참가자는 강한 호기심과 전문가 수준의 학습에 대한 열의, 그리고 개발에 대한 기초적인 지식을 가져야 합니다. Bitcoin에 대한 자세한 배경 지식은 필요하지 않지만, 코딩 원리에 대한 기본적인 이해와 복잡한 기술 개념에 대한 개방성은 집중 육성 프로그램을 최대한 활용하기 위해 필수적입니다.
